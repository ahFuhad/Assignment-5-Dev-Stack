...
function Hero() {
  return (
    <section className="mx-auto grid max-w-356.25 items-center gap-12 px-6 py-20 md:grid-cols-[1.1fr_0.9fr] md:px-24 md:py-24 ">
      {/* Left Side */}
      <div className="max-w-138.75">
        {/* Headline */}
        <h1 className="text-5xl font-bold leading-[1.1] tracking-tight text-slate-900 md:text-[48px]">
          Build Your Ideal 
          <br />
        ...
        {/* Paragraph */}
        <p className="mt-5 max-w-138.75 text-base leading-7 text-slate-500 md:text-[16px]">
